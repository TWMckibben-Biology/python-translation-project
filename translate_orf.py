...
def find_translate_orf(sequence,
        
        #Set start and stop codons
        start_codons = ['AUG'],
        stop_codons = ['UAA', 'UAG', 'UGA'],
            ):
    #Set dictionary for genetic code
    genetic_code = {
    ...
    #Sets variable orf as valid protein-coding mRNA, returns protein translation
...
def main():
    ...
    aa = find_translate_orf(sequence = sequence,
            start_codons = args.start_codon,
            stop_codons = args.stop_codon)    
